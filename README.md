...
- Si quiero desarrollar un método que sea capaz de detectar clicks en una parte de mi aplicación, entonces podemos usar la sentencia addEventListener, de manera que vamos a controlar el evento click (en Javascript).
